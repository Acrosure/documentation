...
ใบคำสั่งซื้อของประกันแต่ละประเภทจะมีโครงสร้างข้อมูลในแบบฟอร์มที่แตกต่างกัน คือฟิลด์ `basic_data`, `package_options` และ `additional_data` ซึ่งสามารถดูโครงสร้างข้อมูลแบบฟอร์มเหล่านี้ได้โดย[ขั้นตอนดังนี้](#how-to-see-form-structure)
