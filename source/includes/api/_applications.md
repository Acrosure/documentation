...
| `status`          | สถานะของใบคำสั่งซื้อ ดูเพิ่มเติมได้ที่ [Status](#status-application)                                        |
...
| `user_id`         | รหัสของผู้ใช้ที่สร้างใบคำสั่งซื้อนี้ (ถ้าใช้ API Key ของ Team จะไม่มีฟิลด์นี้)                              |
